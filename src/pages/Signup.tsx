...
const Signup = () => {
  ...
  const onSubmit = async (data: SignupFormValues) => {
    try {
      setIsLoading(true);
      console.log('Submitting signup form:', { name: data.name, email: data.email });
  ...
  return (
    <div className="flex items-center justify-center min-h-[80vh] bg-gradient-to-b from-green-50 to-white px-4">
